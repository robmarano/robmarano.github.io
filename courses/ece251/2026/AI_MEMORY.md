...
*   **Web Embedding Strategy (`TODO.md`)**: Explore active strategies to convert static markdown blocks into runnable logic natively within the Jekyll `.io` site. Tracked targets include injecting **Monaco IDE** CDN instances, linking interactive **EDA Playground** simulators directly, or natively utilizing a JavaScript execution visualizer (e.g., WebMIPS / MARS-JS).
