...
*   **A.** If you run both algorithms sequentially 100,000 times in the SPIM software emulator, the 2-instruction standard approach finishes almost 3x faster. Explain why the *Emulator Timing Abstraction* (the mathematical reality that software emulators natively execute all assembly instructions as 1 equal software "step" regardless of physical hardware complexity) misrepresents true hardware performance here.
