...
egin{frame}{7. Complex Exception Theory: Restartable & Precise Exceptions}
egin{itemize}
...
egin{frame}{8. Complex Exception Theory: Multiple Fault Constraints}
egin{itemize}
...
egin{frame}[fragile]{9. Global Sandbox: 	exttt{pipelined\_cpu\_exceptions}}
egin{itemize}
...
egin{frame}{10. Debugging Resolutions: 4-Bit ALU Decoupling}
egin{itemize}
...
egin{frame}{11. Debugging Resolutions: Memory Depth \& Aliasing}
egin{itemize}
...
egin{frame}{12. Verification Matrix: The 7 Assembly Playbooks}
egin{itemize}
