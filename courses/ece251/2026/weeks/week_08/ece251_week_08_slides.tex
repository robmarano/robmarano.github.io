...
\begin{frame}{Standard Representation (IEEE 754)}
\begin{center}
    \includegraphics[width=0.95\textwidth,height=0.85\textheight,keepaspectratio]{images/hamacher_fig9_26.png}
\end{center}
\end{frame}
...
\vspace{0.4cm}
\begin{center}
    \textbf{F-Type Instruction Format} \\
    \vspace{0.2cm}
    \begin{tabular}{|c|c|c|c|c|c|}
        \hline
        \textbf{opcode} & \textbf{fmt} & \textbf{ft} & \textbf{fs} & \textbf{fd} & \textbf{funct} \\
        \hline
...
\begin{frame}{Normalizing a Mantissa (IEEE 754)}
\begin{center}
    \includegraphics[width=0.95\textwidth,height=0.85\textheight,keepaspectratio]{images/hamacher_fig9_27.png}
\end{center}
\end{frame}
...
\begin{frame}{FPU Datapath Architecture}
\begin{center}
    \includegraphics[width=0.95\textwidth,height=0.85\textheight,keepaspectratio]{images/hamacher_fig9_28.png}
\end{center}
\end{frame}
...
\begin{frame}{FPU Pipeline Addition Timeline}
\begin{center}
    \includegraphics[width=0.95\textwidth,height=0.85\textheight,keepaspectratio]{images/harris_fig5_29.png}
\end{center}
\end{frame}
...
\begin{itemize}
    ...
    \item \textbf{The MIPS Trick:} Move float to integer register, bit-shift right, subtract from magic constant!
\end{itemize}
\begin{center}
...
\begin{itemize}
    ...
    \item Shifting bits right (\texttt{i >> 1}) mathematically scales exponent by 0.5 (calculating $x^{-0.5}$).
    \item Subtracting from \texttt{0x5f3759df} negates target exponent, approximates curve, and re-aligns $+127$ bias!
\end{itemize}
\end{frame}
